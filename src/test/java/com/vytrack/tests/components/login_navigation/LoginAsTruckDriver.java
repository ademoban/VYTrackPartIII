...
public class LoginAsTruckDriver {
    ...
    public void test1() {
        ...
        WebElement names= driver.findElement(By.xpath("//a[@class='dropdown-toggle'][contains(text(),'Jacquelyn Johnston')]"));

        boolean a=!names.equals("Alena Hagenes")&&!names.equals("Alberto Bins");
